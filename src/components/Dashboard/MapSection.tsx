...
export const MapSection = () => {
  return (
    <Card className="h-[450px]">
      ...
      <CardContent>
        <div className="relative h-[350px] w-full bg-muted dark:bg-gray-800 rounded-md overflow-hidden">
          {/* Placeholder para o mapa - em uma implementação real seria usado um componente de mapa */}
          <div className="absolute inset-0 flex items-center justify-center flex-col">
            <MapPin className="h-12 w-12 text-muted-foreground dark:text-gray-400 mb-2" />
            ...
            <div className="flex flex-wrap gap-2 mt-4 justify-center max-w-md">
              {["SP", "RJ", "MG", "RS", "PR", "SC", "BA", "DF", "GO", "PE"].map((uf) => (
                <Badge key={uf} variant="outline" className="dark:bg-gray-700 dark:text-[#D9B300]/80">
